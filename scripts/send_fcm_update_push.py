...
Phase 1 note: the Godot APK does not yet have an FCM receiver. This step
will run, succeed, and the push will fan out to no one until Phase 2 adds
a custom Android build template with FirebaseMessagingService.
"""
...
def main(argv: list[str]) -> int:
    ...
    try:
        ...
        print(f"FCM push failed: {exc} body={body}", file=sys.stderr)
